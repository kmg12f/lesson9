...
/*  Section #4:  AJAX code to send the HTTP Request, which is the location the user specifies, to the 
    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 Use the following code as an example:
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key=6b4d8f807ee74a8ab25183118162504',
...
*/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=53f47c6a9577484a9b015848162604',
                      data: message             
                })
                .done(function(json){
